  ...
  <div class="navbar navbar-default navbar-fixed-top" role="navigation">
    <div class="container">
      ...
      <div class="navbar-header">
        ...
        <a href="#top" class="navbar-brand smoothScroll"><img src="images/University-of-Lagos-courses.jpg" alt="" class="logo"></a>
        <h4>University of Lagos</h4>
      </div>
        <div class="collapse navbar-collapse">
          <ul class="nav navbar-nav navbar-right">
            <!-- <li><a href="#top" class="smoothScroll"><span>Home</span></a></li> -->
            <li><a href="login.php" class="smoothScroll"><span>Log In</span></a></li>
            <li><a href="signup.php" class="smoothScroll"><span>Sign Up</span></a></li>
...
<section id="home">
  <div class="overlay" style="background: url(./Images/Shuttle.jpg); background-position: center; background-repeat: no-repeat; background-size: cover;"></div>
  <div class="container">
    <div class="row">

      <div class="col-md-offset-1 col-md-10 col-sm-12 wow fadeInUp" data-wow-delay="0.3s">
        <h1 class="wow fadeInUp" data-wow-delay="0.6s">Unilag Transport System</h1>
        ...
        <a href="signup.php" class="smoothScroll btn btn-success btn-lg wow fadeInUp" data-wow-delay="1.2s">Register</a>
      </div>
    </div>
  </div>
</section>
    ...
    <div class="row">
      ...
      <div class="col-md-9 col-sm-8 wow fadeInUp" data-wow-delay="0.2s">
        <div class="about-thumb">
          <h1>About Us</h1>
          <p>The cab and the shuttle are the only two permitted commuter systems in the University.
Campus Transportation was initially in the hands of ULSU(University of Lagos Students Union). 
      ...
      <div class="col-md-3 col-sm-4 wow fadeInUp about-img" data-wow-delay="0.6s">
        <img src="images/cab.jpeg" class="img-responsive img-circle" alt="About">
      </div>
	...
	<div class="container" style="padding-top: 3em;">
		...
		<div class="row">
			...
			<div class="col-md-12 col-sm-12">
				...
				<p class="wow fadeInUp"  data-wow-delay="1s" >Copyright &copy; 2023 Unilag 
