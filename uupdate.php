<?php 
    ...
    $reg = $registration['reg_no'];

    $sql2 = "SELECT * FROM vehicle WHERE reg_no = '$reg'";
...
<?php include('templates/nav.php') ?>
    ...
    <section id="form">
        <div class="container">
            ...
            <form action="uupdate.php?id=<?php echo $id; ?>" method="POST" enctype="multipart/form-data">
            <div class="upload">
