...
$errors = array('reg_no' => '', 'first_name' => '', 'last_name' => '', 'phone_no' => '', 'email' => '', 'mode' => '', 'address' => '', 'state' => '',  'lga' => '', 'dob' => '', 'middle_name' => '', 'gender' => '', 'nok_firstname' => '', 'nok_middlename' => '', 'nok_lastname' => '', 'nok_relationship' => '', 'nok_dob' => '', 'nok_phoneno' => '', 'nok_address' => '', 'plate_no' => '', 'vehicle_name' => '', 'vehicle_colour' => '', 'image' => '');
    ...
    if (array_filter($errors)) {
        ...
        if (mysqli_query($conn, $previous_reg_query)) {
            ...
            if ($reg_checker != null) {
                ...
                $query1 = "INSERT INTO login(username, phone_no, email, password) VALUES('$first_name', '$phone_no', '$email', '$hashedPwd')";
                ...
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <select name="mode" id="mode">
                            ...
                            <option value="Shuttle" <?php if ($mode == 'Shuttle') {
                                                        echo 'selected';
                                                    } ?>>Shuttle</option>
                            <option value="Cab" <?php if ($mode == 'Cab') {
                                                    echo 'selected';
                                                } ?>>Cab</option>
                        </select>
