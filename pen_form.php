...
$driver = $offence = $penalizer = $dof = '';
$errors = array('driver' => '', 'offence' => '', 'penalizer' => '', 'dof' => '');
...
if (isset($_POST['submit'])) {
    ...
    if (empty($_POST['dof'])) {
        $errors['dof'] = 'This field is required <br />';
    } else {
        $dof = $_POST['dof'];
    }
    ...
    if (array_filter($errors)) {
        ...
        if (mysqli_query($conn, $sql4)) {
            ...
            if (mysqli_query($conn, $sql5)) {
                // success
                $_SESSION['status'] = "Penalty Inserted Successfully";
            ...
            <form action="pen_form.php" method="POST">
                ...
                <div class="user-details">
                    ...
                    <div class="input-box">
                        ...
                        <div class="red-text"><?php echo $errors['dof']; ?></div>
                    </div>
                    <div class="input-box">
